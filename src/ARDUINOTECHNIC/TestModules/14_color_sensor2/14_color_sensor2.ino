// 컬러센서
// TCS34725 IC 사용
// 스케치 > 라이브러리 포함하기 > 라이브러리 관리 에서 'Adafruit TCS34725'를 설치해야 함
// RGB to HSV: https://github.com/ratkins/RGBConverter
// RGB to HSV conversion formula: https://www.rapidtables.com/convert/color/rgb-to-hsv.html
...
void loop(void) {
    ...
    //_rgbcnv.rgbToHsv((byte)r, (byte)g, (byte)b, hsv);
    _rgbcnv.rgbToHsv((byte)fr, (byte)fg, (byte)fb, hsv);
     ...
     */
    Serial.print(" [HSV] ");
    Serial.print("H: "); Serial.print(hsv[0]); Serial.print(" ");
    Serial.print("S: "); Serial.print(hsv[1]); Serial.print(" ");
